# Security Analyst agent — understanding (rev 5)
...
Next
- If further empties persist, add a second-pass query that fetches raw hits to sample field presence and adjust the aggregator dynamically.
